...
mkdir -p /usr/local/lib/python3.9/dist-packages/cleanfid/
mkdir -p /usr/local/lib/python3.9/dist-packages/cleanfid/stats/
mkdir -p datasets/
rm -rf datasets/* # clear directory content
cp /notebooks/Homework/hw2/generative-modeling-hw2/CUB_200_2011.tgz datasets/ #recheck the path
...
cp cub_clean_custom_na.npz /usr/local/lib/python3.9/dist-packages/cleanfid/stats/cub_clean_custom_na.npz
